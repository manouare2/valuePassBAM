...
public class AgencyFragment1 extends Fragment implements UIListener {
    ...
    private void initListeners() {
        ...
        telephone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                phoneToCall = telephone.getText().toString();
                checkCallPermission();
            }
        });
        ...
        teleph_exp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                phoneToCall = teleph_exp.getText().toString();
                checkCallPermission();
            }
        });
 ...
 /*                  case R.id.radioButton3:
    ...
    private void checkCallPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && ContextCompat.checkSelfPermission(getContext(), Manifest.permission.CALL_PHONE)
                != PackageManager.PERMISSION_GRANTED) {
            requestPermissions(
                    new String[]{Manifest.permission.CALL_PHONE},
                    Constant.PHONE_CALL_PERMISSION_REQUEST_CODE);
        } else {
            willCall();
        }
    }

    private void willCall() {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == Constant.PHONE_CALL_PERMISSION_REQUEST_CODE &&
