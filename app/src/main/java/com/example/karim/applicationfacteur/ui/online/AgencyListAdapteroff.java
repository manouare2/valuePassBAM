...
public class AgencyListAdapteroff extends BaseAdapter implements UIListener {
    ...
    public AgencyListAdapteroff(AgencyListFragment fragment, ListView myList, LayoutInflater inflater, List<Agency> agencies,Context ctx) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        agency_id.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                db.addData1(agency.getCode_objet(),agency.getCode_envoi(),agency.getAgence(),agency.getMat_agent(),agency.getStatut_ZSD());
