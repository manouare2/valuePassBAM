...
public class Loading1 extends myActivity {
    ...
    String  clientt , mode_liv,designation,code_barre;
     ArrayList<Agency3>  myList1 = new   ArrayList<Agency3>();
   ...
   /*     Thread splashThread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    finishAffinity();
                    Intent intent = new Intent(getApplicationContext(),Raison1.class);
        ...
        Bundle bundle = getIntent().getExtras();
         ...
         myList1 = (ArrayList<Agency3>) getIntent().getSerializableExtra("listagc");
